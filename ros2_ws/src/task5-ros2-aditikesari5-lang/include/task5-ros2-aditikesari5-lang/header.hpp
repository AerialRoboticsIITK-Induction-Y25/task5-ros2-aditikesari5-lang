...
public:
    ...
    // NEW - Getter for altitude
    float get_altitude() const {
        return altitude;
    }
    
    // NEW - Getter for max_altitude
    float get_max_altitude() const {
        return max_altitude;
    }
    
    // NEW - Getter for speed
...
public:    
    ...
    const vector<std::tuple<float, float, float>>& get_waypoints() const {
        return waypoints;
    }
    
    // NEW - Getter for current waypoint index
